...
public class CaptureAndParsingHarFileForPixPngWFTest extends ReportGenerateWittyTest {
...
driver1.get(newurl);
		...
		File harFile = new File("/home/wittyfeed/harfiles/Wittyfeed.har");
		har.writeTo(harFile);
		driver1.quit();

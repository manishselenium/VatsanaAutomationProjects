...
import PagesOnGeeksmate.GeeksmateUserProfilePage;
import UtilsOnFeed.ReadPropertiesFileGeeksmate;


public class GeeksmateUserProfileTestCasesTest extends ReportGenerateGeeksmate {

	static Properties properties = null;
   
	GeeksmateUserProfilePage obj = new GeeksmateUserProfilePage();
...
//		GeeksmateTestCases = extent.createTest("Test 1 - Check Facebook Link");
//		
//		
...
//		GeeksmateTestCases = extent.createTest("Test 1 - Check Twitter Link");
...
//		GeeksmateTestCases = extent.createTest("Test 1 - Check Linkedin Link");

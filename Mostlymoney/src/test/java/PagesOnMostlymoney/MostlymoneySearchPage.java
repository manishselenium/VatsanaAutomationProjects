...
import MostlymoneyTestCases.ReportGenerateMostlymoney;
import UtilsOnFeed.WrapperGenericMethod;

public class MostlymoneySearchPage extends ReportGenerateMostlymoney{
	...
	public void ClickSearchOption(WebDriver driver) throws InterruptedException {
		...
		Action.Sendkeys(driver, SearchBox, "absolute");
		Thread.sleep(2000);

		driver.get("https://www.mostlymoney.me/search?q=absolute");

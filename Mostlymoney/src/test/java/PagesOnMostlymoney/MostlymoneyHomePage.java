...
public class MostlymoneyHomePage {

	By SiteLogo = By.cssSelector(".brand-logo > svg:nth-child(1)");
	By Money= By.cssSelector("li.subMenu:nth-child(1) > a:nth-child(1)");
	By Life = By.cssSelector("li.subMenu:nth-child(2) > a:nth-child(1)");
	By Success = By.cssSelector("li.subMenu:nth-child(3) > a:nth-child(1)");
	By Security = By.cssSelector("li.subMenu:nth-child(4) > a:nth-child(1)");
	...
	public void MoneyCategories(WebDriver driver) {
	...
	public void SuccessCategories(WebDriver driver) {

		int Element = driver.findElements(Success).size();
		Assert.assertEquals(Element, 1);
	}

	public void SecurityCategories(WebDriver driver) {

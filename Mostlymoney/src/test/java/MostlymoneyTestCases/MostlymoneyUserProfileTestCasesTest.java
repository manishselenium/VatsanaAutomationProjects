...
import PagesOnMostlymoney.MosrlymoneyUserProfilePage;
import UtilsOnFeed.ReadPropertiesFileHealthiastic;

public class MostlymoneyUserProfileTestCasesTest extends ReportGenerateMostlymoney {

	static Properties properties = null;

	MosrlymoneyUserProfilePage obj = new MosrlymoneyUserProfilePage();
...
//		MostlymoneyTestCases = extent.createTest("Test 1 - Check Facebook Link");
//		
//		
...
//		MostlymoneyTestCases = extent.createTest("Test 1 - Check Twitter Link");
...
//		MostlymoneyTestCases = extent.createTest("Test 1 - Check Linkedin Link");

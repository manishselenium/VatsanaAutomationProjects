...
public class MostlymoneyHomePageTestcasesTest extends ReportGenerateMostlymoney {

	static Properties properties = null;

	MostlymoneyHomePage obj = new MostlymoneyHomePage();
	...
	@Test(priority = 77)
	public void CheckMoneyCategories() {
		test = extent.createTest("Test 77 - Check Money Categories");

		obj.MoneyCategories(driver);
	}
	...
	@Test(priority = 79)
	public void CheckSuccessCategories() {
		test = extent.createTest("Test 79 - Check Success Categories");

		obj.SuccessCategories(driver);
	}

	@Test(priority = 80)
	public void CheckSecurityCategories() {
		test = extent.createTest("Test 80 - Check Security Categories");

		obj.SecurityCategories(driver);
	}

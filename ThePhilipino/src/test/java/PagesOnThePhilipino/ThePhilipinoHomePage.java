...
public class ThePhilipinoHomePage {

	By SiteLogo = By.cssSelector(".brand-logo > svg:nth-child(1)");
	By Health= By.xpath("/html/body/header/nav/div/ul[1]/li[1]/a");
	By Humor = By.cssSelector("li.subMenu:nth-child(2) > a:nth-child(1)");
	By Celebrity = By.cssSelector("li.subMenu:nth-child(3) > a:nth-child(1)");
	By Technology = By.cssSelector("li.subMenu:nth-child(4) > a:nth-child(1)");
	By Misc = By.cssSelector("li.subMenu:nth-child(5) > a:nth-child(1)");
	By Facts = By.cssSelector("li.subMenu:nth-child(6) > a:nth-child(1)");
	...
	public void HealthCategories(WebDriver driver) {

		int Element = driver.findElements(Health).size();
		Assert.assertEquals(Element, 1);
	}

	public void HumorCategories(WebDriver driver) throws InterruptedException {
	...
	public void TechnologyCategories(WebDriver driver) {

		int Element = driver.findElements(Technology).size();
		Assert.assertEquals(Element, 1);
	}
	
	public void MiscCategories(WebDriver driver) {

		int Element = driver.findElements(Misc).size();
		Assert.assertEquals(Element, 1);
	}

	public void FactsCategories(WebDriver driver) {

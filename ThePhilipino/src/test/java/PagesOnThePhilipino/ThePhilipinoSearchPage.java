...
import ThePhilipinoTestCases.ReportGenerateThePhilipino;
import UtilsOnFeed.WrapperGenericMethod;

public class ThePhilipinoSearchPage extends ReportGenerateThePhilipino{
	...
	public void ClickSearchOption(WebDriver driver) throws InterruptedException {
		...
		Action.Sendkeys(driver, SearchBox, "Christmas");
		Thread.sleep(2000);

		driver.get("https://www.thephilipino.com/search?q=Christmas");

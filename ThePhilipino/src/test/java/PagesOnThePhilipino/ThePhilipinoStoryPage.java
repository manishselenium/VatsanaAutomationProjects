...
public class ThePhilipinoStoryPage {
	...
	By StoryAuthor = By.cssSelector(".web-partnerName");
	By StoryTitle = By.cssSelector("div.row:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(3) > h1:nth-child(1)");
	By StoryDesc = By.cssSelector("h2.web-storyOneLinear");

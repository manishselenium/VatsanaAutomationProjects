...
public class ThePhilipinoHomePageTestcasesTest extends ReportGenerateThePhilipino {

	static Properties properties = null;

	ThePhilipinoHomePage obj = new ThePhilipinoHomePage();
	...
	@Test(priority = 77)
	public void CheckHealthCategories() {
		test = extent.createTest("Test 77 - Check Health Categories");

		obj.HealthCategories(driver);
	}

	@Test(priority = 78)
	public void CheckHumorCategories() throws InterruptedException {
		test = extent.createTest("Test 78 - Check Humor Categories");

		obj.HumorCategories(driver);
	}

	@Test(priority = 79)
	public void CheckTechnologyCategories() {
		test = extent.createTest("Test 79 - Check Technology Categories");

		obj.TechnologyCategories(driver);
	}

	@Test(priority = 80)
	public void CheckMiscCategories() {
		test = extent.createTest("Test 80 - Check Misc Categories");

		obj.MiscCategories(driver);
	}

	@Test(priority = 81)
	public void CheckFactsCategories() {
		test = extent.createTest("Test 81 - Check Facts Categories");

		obj.FactsCategories(driver);
	}

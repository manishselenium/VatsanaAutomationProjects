...
//
//import PagesOnThePhilipino.ThePhilipinoUserProfilePage;
//import UtilsOnFeed.ReadPropertiesFileThePhilipino;
//
//
//public class ThePhilipinoUserProfileTestCasesTest extends ReportGenerateThePhilipino {
//
//	static Properties properties = null;
//   
//	ThePhilipinoUserProfilePage obj = new ThePhilipinoUserProfilePage();
//
//	@Test(priority = 121)
...
////		ThePhilipinoTestCases = extent.createTest("Test 1 - Check Facebook Link");
////		
////		
...
////		ThePhilipinoTestCases = extent.createTest("Test 1 - Check Twitter Link");
...
////		ThePhilipinoTestCases = extent.createTest("Test 1 - Check Linkedin Link");

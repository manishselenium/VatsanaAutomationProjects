...
public class ReportGenerateProgramFoodmate {
...
//			driver.manage().window().maximize();
			...
			//----------------   OperaDriver ----------------------
            String path = "operadriver"; //opera driver path
	        OperaOptions options = new OperaOptions();
	        options.setBinary("/usr/lib/x86_64-linux-gnu/opera/opera");//location wheere opera is installed

...
public class CaptureAndParsingHarFileForPixPngIVTest extends ReportGenerateInnnerVoice {
...
//		FileUtils.copyFile(screenshotFile, new File("/home/wittyfeed/ChromeDriver/SoftwareTestingMaterial.png"));
		...
		File harFile = new File("/home/wittyfeed/harfiles/innervoice.har");
		har.writeTo(harFile);
		driver1.quit();
	...
	public void OpenGoogleappsHar_analyzer() {
		...
		driver.findElement(By.cssSelector("#fileSelector")).sendKeys("/home/wittyfeed/harfiles/innervoice.har");

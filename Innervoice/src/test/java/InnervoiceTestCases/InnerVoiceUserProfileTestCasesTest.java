...
import PagesOnInnervoice.InnerVoiceUserProfilePage;
import UtilsOnFeed.ReadPropertiesFileInnerVoice;


public class InnerVoiceUserProfileTestCasesTest extends ReportGenerateInnnerVoice {

	static Properties properties = null;
   
	InnerVoiceUserProfilePage obj = new InnerVoiceUserProfilePage();
...
//		InnervoiceTestCases = extent.createTest("Test 1 - Check Facebook Link");
//		
//		
...
//		InnervoiceTestCases = extent.createTest("Test 1 - Check Twitter Link");
...
//		InnervoiceTestCases = extent.createTest("Test 1 - Check Linkedin Link");

...
public class InnnerVoiceHomePageTestcasesTest extends ReportGenerateInnnerVoice {

   static Properties properties = null;

	InnervoiceHomePage obj = new InnervoiceHomePage();
	...
	@Test(priority = 77)
	public void CheckExploreCategories() {
		test = extent.createTest("Test 77 - Check Explore Categories");

		obj.ExploreCategories(driver);
	}

	@Test(priority = 78)
	public void CheckTalesCategories() throws InterruptedException {
		test = extent.createTest("Test 78 - Check Tales Categories");

		obj.TalesCategories(driver);
		}

	@Test(priority = 79)
	public void CheckVideosCategories() {
		test = extent.createTest("Test 79 - Check Videos Categories");

		obj.VideosCategories(driver);
	}

	@Test(priority = 80)
	public void CheckExpressCategories( ) {
		test = extent.createTest("Test 80 - Check Express Categories");

		obj.ExpressCategories(driver);
	}

	@Test(priority = 81)
	public void CheckIVPicks( ) {
		test = extent.createTest("Test 81 - Check IVPicks");

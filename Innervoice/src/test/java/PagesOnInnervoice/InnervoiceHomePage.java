...
public class InnervoiceHomePage {

	By SiteLogo = By.cssSelector(".brand-logo > svg:nth-child(1)");
	By Explore = By.cssSelector("li.subMenu:nth-child(1) > a:nth-child(1)");
	By Tales = By.cssSelector("li.subMenu:nth-child(2) > a:nth-child(1)");
	By Videos = By.cssSelector("li.subMenu:nth-child(4) > a:nth-child(1)");
	By Express = By.cssSelector("li.subMenu:nth-child(4) > a:nth-child(1)");
	By IVPicks = By.cssSelector("li.subMenu:nth-child(5) > a:nth-child(1)");
	...
	By TwitterLink = By.cssSelector(
			"ul.right:nth-child(4) > li:nth-child(2) > a:nth-child(1)");
	...
	By YouTubeLink = By.cssSelector(
			"ul.right:nth-child(4) > li:nth-child(4) > a:nth-child(1)");
	...
	By IVVideo1 = By.xpath("/html/body/div[5]/div/div[6]/div[2]/div/a[2]");
	By IVVideo2 = By.xpath("/html/body/div[5]/div/div[6]/div[3]/div/a[2]");
	...
	public void ExploreCategories(WebDriver driver) {

		int Element = driver.findElements(Explore).size();
		Assert.assertEquals(Element, 1);
	}

	public void TalesCategories(WebDriver driver) throws InterruptedException {
	...
	public void ExpressCategories(WebDriver driver) {

		int Element = driver.findElements(Express).size();
		Assert.assertEquals(Element, 1);
	}

	public void IVPicks(WebDriver driver) {
	...
	public void IVVideo1(WebDriver driver) throws InterruptedException {
		WebElement element = driver.findElement(IVVideo1);
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", element);
		Thread.sleep(1000);

		int videoFrame = driver.findElements(IVVideo1).size();
		Assert.assertEquals(videoFrame, 1);

	}

	public void IVVideo2(WebDriver driver) throws InterruptedException {
		WebElement element = driver.findElement(IVVideo2);
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", element);
		Thread.sleep(1000);

		int videoFrame = driver.findElements(IVVideo2).size();
		Assert.assertEquals(videoFrame, 1);

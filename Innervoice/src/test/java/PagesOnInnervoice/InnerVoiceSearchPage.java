...
import InnervoiceTestCases.ReportGenerateInnnerVoice;
import UtilsOnFeed.WrapperGenericMethod;

public class InnerVoiceSearchPage extends ReportGenerateInnnerVoice{
	...
	public void ClickSearchOption(WebDriver driver) throws InterruptedException {
		...
		Action.Sendkeys(driver, SearchBox, "Beautiful Poems");
		Thread.sleep(2000);

		driver.get("https://www.innervoice.ai/search?q=+Beautiful+Poems");

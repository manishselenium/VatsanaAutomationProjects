...
public class OnefeedHomePage {
	...
	By TwitterLink = By.cssSelector("ul.right:nth-child(3) > li:nth-child(3) > a:nth-child(1)");
	By FacebookLink = By.cssSelector("ul.right:nth-child(3) > li:nth-child(4) > a:nth-child(1)");
	By YouTubeLink = By.cssSelector("ul.right:nth-child(3) > li:nth-child(5) > a:nth-child(1)");
	By FeaturedPostImage = By.cssSelector("div.col:nth-child(1) > a:nth-child(1) > div:nth-child(1)");
	By FeaturedPostTitle = By.cssSelector("div.col:nth-child(1) > h1:nth-child(2) > a:nth-child(1)");
	By FeaturedPostAuthor = By.cssSelector(".l9 > p:nth-child(3)");
	By SecondPostImage = By.cssSelector("div.col:nth-child(2) > a:nth-child(1) > div:nth-child(1)");
	By SecondPostTitle = By.cssSelector("div.col:nth-child(2) > h1:nth-child(2)");
	...
	By ThirdPostTitle = By.cssSelector("div.m8:nth-child(3) > h1:nth-child(2)");
	By ThirdPostAuthor = By.cssSelector("div.l3:nth-child(3) > p:nth-child(3) > a:nth-child(2)");
	By LatestStoryImage = By.cssSelector("div.page_card:nth-child(1) > div:nth-child(1) > a:nth-child(1) > div:nth-child(1)");
	By LatestStoryTitle = By.cssSelector("div.page_card:nth-child(1) > div:nth-child(1) > p:nth-child(2)");
	By LatestStoryAuthor = By.cssSelector("div.page_card:nth-child(1) > div:nth-child(1) > p:nth-child(3)");
	...
	By EatSleepReadReaptImage = By.cssSelector("article.col:nth-child(7) > a:nth-child(1) > div:nth-child(1)");
	By EatSleepReadReaptTitle = By.cssSelector("article.col:nth-child(7) > a:nth-child(1) > div:nth-child(2) > h1:nth-child(1)");
	By EatSleepReadReaptAuthor = By.cssSelector("article.col:nth-child(7) > address:nth-child(2) > p:nth-child(1)");

...
public class OneFeedUserProfilePage {
	...
	By DontMissThisStory = By.cssSelector(".vtpl-profile-stories > div:nth-child(1)");
	By LatestStories = By.cssSelector(".vtpl-profile-stories > div:nth-child(3)");

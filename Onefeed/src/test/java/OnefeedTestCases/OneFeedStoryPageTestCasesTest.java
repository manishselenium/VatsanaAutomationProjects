...
import PagesOnOnefeed.OnefeedStoryPage;
import UtilsOnFeed.ReadPropertiesFileOneFeed;


public class OneFeedStoryPageTestCasesTest extends ReportGenerateOnefeed {

	static Properties properties = null;

	OnefeedStoryPage StoryItem = new OnefeedStoryPage();

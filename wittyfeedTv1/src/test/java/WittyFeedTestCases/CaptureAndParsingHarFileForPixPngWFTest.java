...
public class CaptureAndParsingHarFileForPixPngWFTest  {
...
public void RecordHAR() throws InterruptedException {
	...
	driver1.get(
				"https://www.wittyfeed.tv/videos/72628/watch-rustic-sushant-tough-bhumi-in-sonchiriya-trailer-and-travel-to-the-forests-of-chambal?utm_source=homepage_promo");
...
//		FileUtils.copyFile(screenshotFile, new File("/home/wittyfeed/ChromeDriver/SoftwareTestingMaterial.png"));
		...
		File harFile = new File("/home/wittyfeed/harfiles/sonly.har");
		har.writeTo(harFile);
		driver1.quit();
...
//		driver.findElement(By.cssSelector("#fileSelector")).sendKeys("/home/wittyfeed/harfiles/Wittyfeed.har");
//

...
import PagesOnHealthiastic.HealthiasticSearchPage;
import UtilsOnFeed.ReadPropertiesFileHealthiastic;

public class HealthiasticSearchPageTestCasesTest extends ReportGenerateHealthiastic {

	HealthiasticSearchPage obj = new HealthiasticSearchPage();

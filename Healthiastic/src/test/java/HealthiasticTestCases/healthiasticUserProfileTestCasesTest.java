...
import PagesOnHealthiastic.HealthiasticUserProfilePage;
import UtilsOnFeed.ReadPropertiesFileHealthiastic;

public class healthiasticUserProfileTestCasesTest extends ReportGenerateHealthiastic {

	static Properties properties = null;

	HealthiasticUserProfilePage obj = new HealthiasticUserProfilePage();
...
//		HealthiasticTestCases = extent.createTest("Test 1 - Check Facebook Link");
//		
//		
...
//		HealthiasticTestCases = extent.createTest("Test 1 - Check Twitter Link");
...
//		HealthiasticTestCases = extent.createTest("Test 1 - Check Linkedin Link");

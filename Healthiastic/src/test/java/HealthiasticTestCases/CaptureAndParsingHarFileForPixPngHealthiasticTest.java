...
public class CaptureAndParsingHarFileForPixPngHealthiasticTest extends ReportGenerateHealthiastic {
...
//		FileUtils.copyFile(screenshotFile, new File("/home/wittyfeed/ChromeDriver/SoftwareTestingMaterial.png"));
		...
		File harFile = new File("/home/wittyfeed/harfiles/healthiastic.har");
		har.writeTo(harFile);
		driver1.quit();
	...
	public void OpenGoogleappsHar_analyzer() {
		...
		driver.findElement(By.cssSelector("#fileSelector")).sendKeys("/home/wittyfeed/harfiles/healthiastic.har");

...
public class HealthiasticHomePage {

	By SiteLogo = By.cssSelector(".brand-logo > svg:nth-child(1)");
	By TipsAndTricks= By.xpath("/html/body/header/nav/div/ul[1]/li[1]/a");
	By WomensHealth = By.cssSelector("li.subMenu:nth-child(2) > a:nth-child(1)");
	By HealthAlert = By.cssSelector("li.subMenu:nth-child(3) > a:nth-child(1)");
	By Lifestyle = By.cssSelector("li.subMenu:nth-child(4) > a:nth-child(1)");
	By Beauty = By.cssSelector("li.subMenu:nth-child(5) > a:nth-child(1)");
	...
	public void WomensHealthCategories(WebDriver driver) throws InterruptedException {
	...
	public void HealthAlertCategories(WebDriver driver) {

		int Element = driver.findElements(HealthAlert).size();
		Assert.assertEquals(Element, 1);
	}

	public void LifestyleCategories(WebDriver driver) {

		int Element = driver.findElements(Lifestyle).size();
		Assert.assertEquals(Element, 1);
	}
	
	public void BeautyCategories(WebDriver driver) {

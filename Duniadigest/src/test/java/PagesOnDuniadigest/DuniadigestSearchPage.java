...
import DuniadigestTestCases.ReportGenerateDuniadigest;
import UtilsOnFeed.WrapperGenericMethod;

public class DuniadigestSearchPage extends ReportGenerateDuniadigest{
	...
	public void ClickSearchOption(WebDriver driver) throws InterruptedException {
		...
		Action.Sendkeys(driver, SearchBox, "साल 2018");
		Thread.sleep(2000);

		driver.get("https://www.duniadigest.com/search?q=+%E0%A4%B8%E0%A4%BE%E0%A4%B2+2018");

...
import PagesOnDuniadigest.DuniadigestUserProfilePage;
import UtilsOnFeed.ReadPropertiesFileDuniadigest;


public class DuniadigestUserProfileTestCasesTest extends ReportGenerateDuniadigest {

	static Properties properties = null;
   
	DuniadigestUserProfilePage obj = new DuniadigestUserProfilePage();
...
//		DuniadigestTestCases = extent.createTest("Test 1 - Check Facebook Link");
//		
//		
...
//		DuniadigestTestCases = extent.createTest("Test 1 - Check Twitter Link");
...
//		DuniadigestTestCases = extent.createTest("Test 1 - Check Linkedin Link");

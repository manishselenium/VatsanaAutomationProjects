...
public class CaptureAndParsingHarFileForPixPngDDTest extends ReportGenerateDuniadigest {
...
//			FileUtils.copyFile(screenshotFile, new File("/home/wittyfeed/ChromeDriver/SoftwareTestingMaterial.png"));
			...
			File harFile = new File("/home/wittyfeed/harfiles/duniadigest.har");
			har.writeTo(harFile);
			driver1.quit();
	...
	public void OpenGoogleappsHar_analyzer() {
		...
		driver.findElement(By.cssSelector("#fileSelector")).sendKeys("/home/wittyfeed/harfiles/duniadigest.har");

...
import PagesOnDuniadigest.DuniadigestSearchPage;
import UtilsOnFeed.ReadPropertiesFileDuniadigest;

public class DuniadigestSearchPageTestCasesTest extends ReportGenerateDuniadigest {

	DuniadigestSearchPage obj = new DuniadigestSearchPage();

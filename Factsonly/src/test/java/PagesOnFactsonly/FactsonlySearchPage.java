...
import FactsonlyTestCases.ReportGenerateFactsonly;
import UtilsOnFeed.WrapperGenericMethod;

public class FactsonlySearchPage extends ReportGenerateFactsonly{
	...
	public void ClickSearchOption(WebDriver driver) throws InterruptedException {
		...
		driver.get("https://www.factsonly.me/search?q=test");

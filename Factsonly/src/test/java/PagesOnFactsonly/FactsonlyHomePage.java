...
public class FactsonlyHomePage {

	By SiteLogo = By.cssSelector(".brand-logo > svg:nth-child(1)");
	By Creepy= By.cssSelector("li.subMenu:nth-child(1) > a:nth-child(1)");
	By History= By.cssSelector("li.subMenu:nth-child(2) > a:nth-child(1)");
	By Entertainment = By.cssSelector("li.subMenu:nth-child(3) > a:nth-child(1)");
	By Science = By.cssSelector("li.subMenu:nth-child(4) > a:nth-child(1)");
	By Culture = By.cssSelector("li.subMenu:nth-child(5) > a:nth-child(1)");
	...
	public void CreepyCategories(WebDriver driver) {

		int Element = driver.findElements(Creepy).size();
		Assert.assertEquals(Element, 1);
	}

	public void HistoryCategories(WebDriver driver) throws InterruptedException {
	...
	public void ScienceCategories(WebDriver driver) {

		int Element = driver.findElements(Science).size();
		Assert.assertEquals(Element, 1);
	}
	
	public void CultureCategories(WebDriver driver) {

...
import PagesOnFactsonly.FactsonlyUserProfilePage;
import UtilsOnFeed.ReadPropertiesFileFactsonly;

public class FactsonlyUserProfileTestCasesTest extends ReportGenerateFactsonly {

	static Properties properties = null;

	FactsonlyUserProfilePage obj = new FactsonlyUserProfilePage();
...
//		FactsonlyTestCases = extent.createTest("Test 1 - Check Facebook Link");
//		
//		
...
//		FactsonlyTestCases = extent.createTest("Test 1 - Check Twitter Link");
...
//		FactsonlyTestCases = extent.createTest("Test 1 - Check Linkedin Link");

...
public class guru99  {
	...
	public void RecordHAR() {
		...
		try {
			...
			driver1.get(
					"https://www.wittyfeed.tv/devendra-fadnavis-unveils-first-poster-of-vivek-oberois-pm-narendra-modi-and-twitter-has-given-its-judgement-72640?utm_source=homepage_promo");
			...
			File harFile = new File("/home/wittyfeed/harfiles/The1.har");
			har.writeTo(harFile);
			driver1.quit();
...
//		driver.findElement(By.cssSelector("#fileSelector")).sendKeys("/home/wittyfeed/new.har");
//

...
//	WebDriver driver = new ChromeDriver();
	...
	public void CreatHarFile() throws HarReaderException {
		...
		System.setProperty("phantomjs.binary.path", "/home/wittyfeed/ChromeDriver/phantomjs-2.1.1-linux-x86_64/bin/phantomjs");
...
//          driver = new ChromeDriver(seleniumCapabilities);
		...
		try {
			...
			driver.navigate().to("https://www.innervoice.ai/basic-beliefs-that-are-the-pillars-of-hindu-dharma-72087/");
			...
			File harFile = new File("/home/wittyfeed/new.har");
			har.writeTo(harFile);

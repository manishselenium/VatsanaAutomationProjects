...
public class FoodMateHomePage {

	By SiteLogo = By.cssSelector(".brand-logo > svg:nth-child(1)");
    By Recipes = By.cssSelector("li.subMenu:nth-child(1) > a:nth-child(1)");
	By Culture = By.cssSelector("li.subMenu:nth-child(2) > a:nth-child(1)");
	By TipsAndTricks = By.cssSelector("li.subMenu:nth-child(3) > a:nth-child(1)");
	By FoodFun = By.cssSelector("li.subMenu:nth-child(4) > a:nth-child(1)");
	By Videos = By.cssSelector("li.subMenu:nth-child(5) > a:nth-child(1)");
	By SearchOption = By.cssSelector(".searchselect > svg:nth-child(1)");
    By TwitterLink = By.cssSelector(".right > li:nth-child(2) > a:nth-child(1)");
	By FacebookLink = By.cssSelector(".right > li:nth-child(3) > a:nth-child(1)");
	By YouTubeLink = By.cssSelector(".right > li:nth-child(4) > a:nth-child(1)");
	...
	By ThirdPostTitle = By.xpath("/html/body/div[5]/div/div[3]/p[1]");
	...
	By FMVideo1 = By.cssSelector("#hm_vid_1 > a:nth-child(2)");
	By FMVideo2 = By.cssSelector("#hm_vid_2 > a:nth-child(2)");
	...
	public void RecipesCategories(WebDriver driver) {

		int Element = driver.findElements(Recipes).size();
		Assert.assertEquals(Element, 1);
	}

	public void CultureCategories(WebDriver driver) throws InterruptedException {
	...
	public void TipsAndTricksCategories(WebDriver driver) {

		int Element = driver.findElements(TipsAndTricks).size();
		Assert.assertEquals(Element, 1);
	}

	public void FoodFun(WebDriver driver) {
	...
	public void FMVideo1(WebDriver driver) throws InterruptedException {
		WebElement element = driver.findElement(FMVideo1);
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", element);
		Thread.sleep(1000);

		int videoFrame = driver.findElements(FMVideo1).size();
		Assert.assertEquals(videoFrame, 1);

	}

	public void FMVideo2(WebDriver driver) throws InterruptedException {
		WebElement element = driver.findElement(FMVideo2);
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", element);
		Thread.sleep(1000);

		int videoFrame = driver.findElements(FMVideo2).size();
		Assert.assertEquals(videoFrame, 1);

...
import PagesOnFoodMate.FoodMateUserProfilePage;
import UtilsOnFeed.ReadPropertiesFilefoodmate;


public class FoodMateUserProfileTestCasesTest extends ReportGenerateFoodMate {

	static Properties properties = null;
   
	FoodMateUserProfilePage obj = new FoodMateUserProfilePage();
...
//		FoodMateTestCases = extent.createTest("Test 1 - Check Facebook Link");
//		
//		
...
//		FoodMateTestCases = extent.createTest("Test 1 - Check Twitter Link");
...
//		FoodMateTestCases = extent.createTest("Test 1 - Check Linkedin Link");

...
import PagesOnHollywoodpie.HollywoodpieSearchPage;
import UtilsOnFeed.ReadPropertiesFileHealthiastic;

public class HollywoodpieSearchPageTestCasesTest extends ReportGenerateHollywoodpie {

	HollywoodpieSearchPage obj = new HollywoodpieSearchPage();

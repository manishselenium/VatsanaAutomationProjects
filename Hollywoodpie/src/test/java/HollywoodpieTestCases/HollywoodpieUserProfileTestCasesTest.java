...
import PagesOnHollywoodpie.HealthiasticUserProfilePage;
import UtilsOnFeed.ReadPropertiesFileHealthiastic;

public class HollywoodpieUserProfileTestCasesTest extends ReportGenerateHollywoodpie {
...
//		HollywoodpieTestCases = extent.createTest("Test 1 - Check Facebook Link");
//		
//		
...
//		HollywoodpieTestCases = extent.createTest("Test 1 - Check Twitter Link");
...
//		HollywoodpieTestCases = extent.createTest("Test 1 - Check Linkedin Link");

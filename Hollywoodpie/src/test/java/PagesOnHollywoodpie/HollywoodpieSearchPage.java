...
import HollywoodpieTestCases.ReportGenerateHollywoodpie;
import UtilsOnFeed.WrapperGenericMethod;

public class HollywoodpieSearchPage extends ReportGenerateHollywoodpie{
	...
	public void ClickSearchOption(WebDriver driver) throws InterruptedException {
		...
		Action.Sendkeys(driver, SearchBox, "Movie");
		Thread.sleep(2000);

		driver.get("https://www.hollywoodpie.com/search?q=Movie");

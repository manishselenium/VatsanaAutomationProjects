...
public class HealthiasticUserProfilePage {

	By BackgroundImage = By.cssSelector(".profile-back-overlay");
    By AuthorName = By.cssSelector("div.col:nth-child(1) > p:nth-child(3) > a:nth-child(2)");
	By AuthorImage = By.cssSelector(".web-profile-img");
	By WriterName = By.cssSelector(".web-profile-writerName");
	By Editor = By.cssSelector(".web-profile-writerEmail");
